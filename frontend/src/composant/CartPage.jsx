...
const initialCart = [
  {
    ...
    price: 6.3,
    quantity: 1,
    image: "https://via.placeholder.com/80x80/ffffff/000000?text=IPA",
  },
  {
    id: 2,
    name: "Syrah",
    price: 16.4,
    quantity: 2,
    image: "https://via.placeholder.com/80x80/ffffff/000000?text=Syrah",
  },
  {
    id: 3,
    name: "Blue Jamaica",
    price: 9.2,
    quantity: 1,
    image: "https://via.placeholder.com/80x80/ffffff/000000?text=Blue",
  },
];
          ...
          {cart.length === 0 ? (
            ...
            cart.map((item) => (
              <div key={item.id} className="cart-product">
                ...
                <div className="quantity-control">
                  <button onClick={() => decrement(item.id)} className="qty-btn">
                    <FaMinus />
                  </button>
                  <span>{item.quantity}</span>
